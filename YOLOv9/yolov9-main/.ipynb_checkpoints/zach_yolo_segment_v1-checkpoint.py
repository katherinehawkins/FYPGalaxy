...
model = YOLO('runs/segment/tune3/weights/best.pt', task = 'segment')


# Fine Tuning
#model.tune(data='data/RadioGalaxyNetSeg.yaml', epochs=400, iterations=20, optimizer='SGD', plots=True, save=True, val=True, batch = 8, patience = 250)
...
# Example usage
solve("runs/segment/tune3/weights/best.pt", "../datasets/RadioGalaxyNET/data/RadioGalaxyNETSeg/images/test", "../datasets/RadioGalaxyNET/data/RadioGalaxyNETSeg/labels/test")