...
def run(
        ...
        task='val',  # train, val, test, speed or study #THIS WAS val ZACH______________________________________________
        ...
        project=ROOT / 'runs/val',  # save to project/name #this was val ZACH _______________________
